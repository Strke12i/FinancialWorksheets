...
Future<void> initializeNotificationService() async {
  ...
  try {
    ...
    debugPrint("Serviço de notificações iniciado.");
  } on PlatformException catch (e) {
    debugPrint("Erro ao iniciar o serviço de notificações: ${e.message}");
  }
}
...
class UsageService {
  ...
  Future<void> _checkUsageStatsPermission() async {
    print("Entrou aqui");
    try {
      final bool isGranted = await platform.invokeMethod('checkUsagePermission');
      debugPrint("Usage permission is granted: $isGranted");
      if (!isGranted) {
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    super.initState();
    UsageService()._checkUsageStatsPermission();
  }
